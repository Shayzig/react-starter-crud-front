...
function query(filterBy) {
    ...
    if (filterBy) {
        ...
        itemsToReturn = gItems.filter(item => item.type.toLowerCase().includes(type.toLowerCase()) && item.model.toLowerCase().includes(model.toLowerCase())
